...
func TestIncorrectPriceProductCreate(t *testing.T) {
	...
	_, err := product.Product.Create(product.Product{}, vo.ProductID{Value: uuid.New()}, incorrectPrice, 0, "", "")
...
func TestIncorrectDiscountProductCreate(t *testing.T) {
	...
	_, err := product.Product.Create(product.Product{}, vo.ProductID{Value: uuid.New()}, 100, discount, "", "")
